...
TEST_F(SimpleArrayTest, Compilation)
{
    ...
    SimpleArray b(0); // This line is correct
    // implicitConversionTest(0);         // This line is incorrect
    // SimpleArray c = new TestType[100]; // This line is incorrect
    // SimpleArray d = 0;                 // This line is incorrect
